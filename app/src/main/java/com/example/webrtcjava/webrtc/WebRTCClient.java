package com.example.webrtcjava.webrtc;
...
public class WebRTCClient {
    ...
    private String localStreamId="local_steam";
    ...
    public WebRTCClient(Context context, PeerConnection.Observer observer,String username){
        ...
        this.username =username;
         ...
         iceServer.add(PeerConnection.IceServer.builder("turn:a.relay.metered.ca:433?transport=tcp")
    ...
    //intializing peer connection section
